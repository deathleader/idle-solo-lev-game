    ...
    return (
      <div style={panelStyles}>
        <div style={noPointsStyles}>
          ...
          <h3 style={{fontSize: '20px', fontWeight: '700', color: '#94a3b8', margin: '0 0 8px 0'}}>
    ...
    <div style={panelStyles}>
      <div style={headerStyles}>
        <div style={titleSectionStyles}>
          ...
          <div>
            <h3 style={{fontSize: '20px', fontWeight: '800', margin: '0 0 4px 0'}}>Allocate Stat Points</h3>
            <p style={{fontSize: '14px', color: '#94a3b8', margin: 0}}>Enhance your hunter abilities</p>
          </div>
        </div>
            ...
            >
              <div style={statHeaderStyles}>
                <div style={statInfoStyles}>
                  <div style={statIconStyles(stat.color)}>
                    <IconComponent style={{width: '20px', height: '20px', color: stat.color}} />
                  </div>
                  <div>
                    <div style={{display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '4px'}}>
                      <span style={{fontSize: '18px', fontWeight: '700', color: stat.color}}>
                        {stat.name}
                      </span>
                      <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  width: `${Math.min((player.stats[stat.key] / 50) * 100, 100)}%`,
      ...
      <div style={tipStyles}>
        ...
        <div>
          <h4 style={{fontSize: '14px', fontWeight: '600', color: '#fbbf24', margin: '0 0 4px 0'}}>
            Pro Tip
          </h4>
          <p style={{fontSize: '12px', color: '#94a3b8', margin: 0, lineHeight: '1.4'}}>
            Balanced stats work well for beginners, but specializing in specific areas can create powerful builds. 
            Experiment with different combinations to find your playstyle!
          </p>
        </div>
      </div>
    </div>
